...
const doctors = [
	{ id: 1, name: 'Dr. David', specialty: 'Dentist', time: '10:30am - 5:30pm' },
	{ id: 2, name: 'Dr. Isaac', specialty: 'Hematologist', time: '10:30am - 5:30pm' },
	{ id: 3, name: 'Dr. Grace', specialty: 'Radiologist', time: '10:30am - 5:30pm' },
];
			...
			<View style={styles.header}>
				<View style={styles.userInfo}>
					...
					<View>
						...
						<ThemedText style={styles.studentId}>Student ID</ThemedText>
					</View>
				</View>
				<Image
